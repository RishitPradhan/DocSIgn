            ...
            {numPages > 1 && (
              <div className="flex items-center justify-center space-x-4 p-4 bg-gray-50 border-b border-gray-200">
                <button
                  ...
                  className="px-3 py-1 text-sm text-gray-600 hover:text-gray-900 disabled:opacity-50 disabled:cursor-not-allowed rounded border border-gray-300 hover:bg-white transition-colors"
                >
                  Previous
                </button>
